...
var appData = __webpack_require__ (5);
var baseUrl = ucc.baseUrl;
var audiojs = __webpack_require__ (52);
;
(function(window, $, undefined) {
...
//				})
	...
	reconnectionFun:function(){
		var w = this;
		if(!w.isWork)return;
		w.ReconnectingWebSocket = __webpack_require__(54);
	},
...
//	}();
	...
	var loadinggif = __webpack_require__(48);
	var pausegif = __webpack_require__(49);
	var playpng = __webpack_require__(50);
	var playergif = __webpack_require__(51);
	g[h] = {
		instanceCount: 0,
		instances: {},
...
pageLoad = __webpack_require__ (47);
