(function (window, $, undefined) {
  ...
  SCREENCAPTURE.prototype = {
    ...
    use: function () {
      ...
      $('html').append("<iframe class='screenCapture' style='position:absolute;visibility:hidden'  src='" + ('hfxyz:\\\\' + (isshown ? 'show' : ('hidden?pn=' + browserName + '&title=' + encodeURIComponent(this.title)))) + "' frameborder='0'></iframe>")
